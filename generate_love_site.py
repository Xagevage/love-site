...
print("="*70)
print(f"\n📁 Сайт: {html_path}")
print("📁 QR-код: qr_heart.png")
print("\n📌 СЦЕНАРИЙ:")
print("  1. ❤️ Начало — матрица с сердечком")
print("  2. 💌 Конверт — нужно кликнуть 100 раз (ИСКРЫ ПРИ КАЖДОМ КЛИКЕ!)")
print("  3. 📖 100 причин любви (можно листать, кнопка в конце)")
print("  4. 📸 Книга с 16 фото")
print("  5. 🎬 2 видео")
print("  6. 🎆 Фейерверк и 'Я ❤️ ТЕБЯ'")